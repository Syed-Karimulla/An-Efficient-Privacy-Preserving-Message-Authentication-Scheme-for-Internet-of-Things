...
public class SinkD extends JFrame implements ActionListener {
	...
	SinkD() {
		...
		ImageIcon img1 = new ImageIcon(this.getClass().getResource("Enduser5.png"));
		imagelabel.setIcon(img1);
		imagelabel.setBounds(0, 0, 600,600);

		jf = new JFrame("Sink D::An Efficient Privacy Preserving Message Authentication Scheme for Internet of Things");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(600,600);
	...
	public void actionPerformed(ActionEvent a1) 
	{
		if(a1.getSource()==b1)
		{
			...
			try
			{
				...
				try {
				    out1= new PrintStream(new FileOutputStream("NodeD\\"+fname));
				    out1.print(data);
				}
				finally {
