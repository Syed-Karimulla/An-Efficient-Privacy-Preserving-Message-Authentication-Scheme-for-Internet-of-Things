...
public class SinkC extends JFrame implements ActionListener {
	...
	SinkC() {
		...
		jf = new JFrame("Sink C::An Efficient Privacy Preserving Message Authentication Scheme for Internet of Things");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(600,600);
