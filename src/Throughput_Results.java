  ...
  String fname=null,fname1=null,fname2=null,fname3=null,fname4=null,fname5=null,fname6=null,fname7=null;
    	...
    	try
    	{
    		...
    		while(rs.next()==true)
    		{
    	        ...
    	        JFreeChart chart = ChartFactory.createBarChart3D("An Efficient Privacy Preserving Message Authentication Scheme for Internet of Things", "Througput(Kbps) ", "Total Throughput (Kbps)",
