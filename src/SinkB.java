...
public class SinkB extends JFrame implements ActionListener {
	...
	SinkB() {
		...
		jf = new JFrame("Sink B::An Efficient Privacy Preserving Message Authentication Scheme for Internet of Things");
		c = jf.getContentPane();
		c.setLayout(null);
		jf.setSize(600,600);
